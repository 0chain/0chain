...
try_five_times_on_error ./zwalletcli/zwallet --wallet testing.json getbalance
...
# for test logs
try_five_times_on_error ./zboxcli/zbox --wallet testing.json ls-blobbers
...
try_five_times_on_error ./zboxcli/zbox --wallet testing.json newallocation \
    ...
    --lock 0.0001048576 --data 1 --parity 1 --expire 48h

# 0.0002097152

# create random file
head -c 104857600 < /dev/urandom > random.bin
