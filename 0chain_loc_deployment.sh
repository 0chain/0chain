...
cp docker.local/config/b0magicBlock_4_miners_1_sharder.json 0dns/docker.local/config/magic_block.json
...
(
  cd docker.local || exit
  echo "Setup sharders and miners"
  pwd
