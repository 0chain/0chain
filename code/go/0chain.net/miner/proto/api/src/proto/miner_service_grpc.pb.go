...
func (c *minerServiceClient) GetChainStats(ctx context.Context, in *GetChainStatsRequest, opts ...grpc.CallOption) (*GetChainStatsResponse, error) {
	out := new(GetChainStatsResponse)
	err := c.cc.Invoke(ctx, "/miner.MinerService/GetChainStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMinerServiceServer) GetChainStats(context.Context, *GetChainStatsRequest) (*GetChainStatsResponse, error) {
...
func _MinerService_GetChainStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetChainStatsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MinerServiceServer).GetChainStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/miner.MinerService/GetChainStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MinerServiceServer).GetChainStats(ctx, req.(*GetChainStatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MinerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MinerService_GetChainStats_Handler,
		},
	},
