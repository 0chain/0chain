...
type MinerServiceClient interface {
	...
	//
	GetSignShare(ctx context.Context, in *GetSignShareRequest, opts ...grpc.CallOption) (*GetSignShareResponse, error)
}
...
func (c *minerServiceClient) GetSignShare(ctx context.Context, in *GetSignShareRequest, opts ...grpc.CallOption) (*GetSignShareResponse, error) {
	out := new(GetSignShareResponse)
	err := c.cc.Invoke(ctx, "/miner.MinerService/GetSignShare", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MinerServiceServer interface {
	...
	//
	GetSignShare(context.Context, *GetSignShareRequest) (*GetSignShareResponse, error)
}
...
func (UnimplementedMinerServiceServer) GetSignShare(context.Context, *GetSignShareRequest) (*GetSignShareResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSignShare not implemented")
}
...
func _MinerService_GetSignShare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSignShareRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MinerServiceServer).GetSignShare(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/miner.MinerService/GetSignShare",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MinerServiceServer).GetSignShare(ctx, req.(*GetSignShareRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MinerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSignShare",
			Handler:    _MinerService_GetSignShare_Handler,
		},
	},
