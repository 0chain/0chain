...
type ConfigUpdateRequest struct {
	...
	GenerateTimeout string `protobuf:"bytes,1,opt,name=generate_timeout,json=generateTimeout,proto3" json:"generate_timeout,omitempty"`
	TxnWaitTime     string `protobuf:"bytes,2,opt,name=txn_wait_time,json=txnWaitTime,proto3" json:"txn_wait_time,omitempty"`
}
...
func (x *ConfigUpdateRequest) GetGenerateTimeout() string {
	if x != nil {
...
func (x *ConfigUpdateRequest) GetTxnWaitTime() string {
	if x != nil {
		return x.TxnWaitTime
	}
	return ""
}
...
var file_miner_contract_proto_rawDesc = []byte{
	...
	0x22, 0x64, 0x0a, 0x13, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x29, 0x0a, 0x10, 0x67, 0x65, 0x6e, 0x65, 0x72,
	0x61, 0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f,
	0x75, 0x74, 0x12, 0x22, 0x0a, 0x0d, 0x74, 0x78, 0x6e, 0x5f, 0x77, 0x61, 0x69, 0x74, 0x5f, 0x74,
	0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x74, 0x78, 0x6e, 0x57, 0x61,
	0x69, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x2e, 0x5a, 0x2c, 0x63, 0x6f, 0x64, 0x65, 0x2f, 0x67,
...
var file_miner_contract_proto_goTypes = []interface{}{
	...
	(*ConfigUpdateRequest)(nil),       // 7: miner.ConfigUpdateRequest
