...
func (x *StartChainRequest) Reset() {
	*x = StartChainRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *StartChainRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartChainRequest) ProtoMessage() {}

func (x *StartChainRequest) ProtoReflect() protoreflect.Message {
	mi := &file_miner_contract_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartChainRequest.ProtoReflect.Descriptor instead.
func (*StartChainRequest) Descriptor() ([]byte, []int) {
	return file_miner_contract_proto_rawDescGZIP(), []int{7}
}

func (x *StartChainRequest) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *StartChainRequest) GetRound() int64 {
	if x != nil {
		return x.Round
	}
	return 0
...
func (x *StartChainResponse) Reset() {
	*x = StartChainResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *StartChainResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartChainResponse) ProtoMessage() {}

func (x *StartChainResponse) ProtoReflect() protoreflect.Message {
	mi := &file_miner_contract_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartChainResponse.ProtoReflect.Descriptor instead.
func (*StartChainResponse) Descriptor() ([]byte, []int) {
	return file_miner_contract_proto_rawDescGZIP(), []int{8}
}

func (x *StartChainResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *StartChainResponse) GetStart() bool {
	if x != nil {
		return x.Start
	}
	return false
...
var file_miner_contract_proto_rawDesc = []byte{
	...
	0x22, 0x42, 0x0a, 0x11, 0x53, 0x74, 0x61, 0x72, 0x74, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x52, 0x65,
	...
	0x6f, 0x75, 0x6e, 0x64, 0x22, 0x3a, 0x0a, 0x12, 0x53, 0x74, 0x61, 0x72, 0x74, 0x43, 0x68, 0x61,
...
var file_miner_contract_proto_goTypes = []interface{}{
	...
	(*StartChainRequest)(nil),         // 7: miner.StartChainRequest
	(*StartChainResponse)(nil),        // 8: miner.StartChainResponse
...
func file_miner_contract_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_miner_contract_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StartChainRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_miner_contract_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StartChainResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
