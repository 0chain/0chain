...
func (x *SignRequest) GetPrivateKey() string {
	if x != nil {
		return x.PrivateKey
	}
	return ""
...
func (x *SignRequest) GetTimeStamp() string {
	if x != nil {
		return x.TimeStamp
	}
	return ""
...
func (x *SignResponse) GetClientId() string {
	if x != nil {
		return x.ClientId
	}
	return ""
...
var file_miner_contract_proto_rawDesc = []byte{
	...
	0x22, 0x80, 0x01, 0x0a, 0x0b, 0x53, 0x69, 0x67, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x64, 0x61, 0x74, 0x61, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x73, 0x74, 0x61,
	0x6d, 0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x53, 0x74,
	0x61, 0x6d, 0x70, 0x22, 0x5d, 0x0a, 0x0c, 0x53, 0x69, 0x67, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x72, 0x65, 0x42, 0x2e, 0x5a, 0x2c, 0x63, 0x6f, 0x64, 0x65, 0x2f, 0x67, 0x6f, 0x2f, 0x30, 0x63,
...
var file_miner_contract_proto_goTypes = []interface{}{
	...
	(*SignRequest)(nil),               // 7: miner.SignRequest
	(*SignResponse)(nil),              // 8: miner.SignResponse
