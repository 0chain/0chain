...
func (x *PutTransactionResponse) GetTransaction() string {
	if x != nil {
		return x.Transaction
	}
	return ""
...
var file_miner_contract_proto_rawDesc = []byte{
	...
	0x3a, 0x0a, 0x16, 0x50, 0x75, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f,
	...
	0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x2e, 0x5a, 0x2c, 0x63,
...
var file_miner_contract_proto_depIdxs = []int32{
	...
	14, // 11: miner.MagicBlock.ShareOrSigns.share_or_sign:type_name -> miner.MagicBlock.ShareOrSigns.ShareOrSignEntry
	9,  // 12: miner.MagicBlock.SharesEntry.value:type_name -> miner.MagicBlock.ShareOrSigns
	10, // 13: miner.MagicBlock.MpksEntry.value:type_name -> miner.MagicBlock.MPK
	13, // 14: miner.MagicBlock.ShareOrSigns.ShareOrSignEntry.value:type_name -> miner.MagicBlock.ShareOrSigns.DKGKeyShare
	17, // 15: miner.Pool.Node.info:type_name -> miner.Pool.Node.Info
	15, // 16: miner.Pool.NodesEntry.value:type_name -> miner.Pool.Node
