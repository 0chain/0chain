...
func (_m *ProtocolBlock) AddVerificationTicket(ctx context.Context, b *block.Block, bvt *block.VerificationTicket) bool {
...
func (_m *ProtocolBlock) GenerateBlock(ctx context.Context, b *block.Block, bsh chain.BlockStateHandler, waitOver bool) error {
...
func (_m *ProtocolBlock) IsBlockNotarized(ctx context.Context, b *block.Block) bool {
	ret := _m.Called(ctx, b)
...
func (_m *ProtocolBlock) VerifyNotarization(ctx context.Context, b *block.Block, bvt []*block.VerificationTicket, _a3 int64) error {
...
func (_m *ProtocolBlock) VerifyTicket(ctx context.Context, blockHash string, vt *block.VerificationTicket, _a3 int64) error {
