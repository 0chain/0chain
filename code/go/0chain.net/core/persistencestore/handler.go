...
/*WithConnectionJSONHandler - a json request response handler that adds a persistencestore connection to the Context
* It reclaims the connection at the end so there is no connection leak
 */
...
/*WithConnectionEntityJSONHandler - a json request response handler that adds a persistencestore connection to the Context
