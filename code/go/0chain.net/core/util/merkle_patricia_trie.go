...
func (mpt *MerklePatriciaTrie) GetNodeValue(path Path, v MPTSerializable) (MPTSerializable, error) {
...
func (mpt *MerklePatriciaTrie) Insert(path Path, value MPTSerializable) error {
	if value == nil {
