...
func TestCreateNewProviderAggregates(t *testing.T) {
	...
	assert.Equal(t, blobbers[0].LastHealthCheck, b1.LastHealthCheck)
	...
	assert.Equal(t, blobbers[1].LastHealthCheck, b2.LastHealthCheck)
	...
	assert.Equal(t, miners[0].LastHealthCheck, m1.LastHealthCheck)
	...
	assert.Equal(t, miners[1].LastHealthCheck, m2.LastHealthCheck)
	...
	assert.Equal(t, sharders[0].LastHealthCheck, s1.LastHealthCheck)
	...
	assert.Equal(t, sharders[1].LastHealthCheck, s2.LastHealthCheck)
	...
	assert.Equal(t, validators[0].BaseUrl, v1.URL)
	assert.Equal(t, validators[0].LastHealthCheck, v1.LastHealthCheck)
	...
	assert.Equal(t, validators[1].BaseUrl, v2.URL)
	assert.Equal(t, validators[1].LastHealthCheck, v2.LastHealthCheck)
	...
	assert.Equal(t, authorizers[0].LastHealthCheck, a1.LastHealthCheck)
	...
	assert.Equal(t, authorizers[1].LastHealthCheck, a2.LastHealthCheck)
