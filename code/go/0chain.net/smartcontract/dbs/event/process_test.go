...
func TestUpdateHistoricData(t *testing.T) {
	...
	assert.Equal(t, blobbers[0].LastHealthCheck, ba1.LastHealthCheck)
	...
	assert.Equal(t, blobbers[1].LastHealthCheck, ba2.LastHealthCheck)
	...
	assert.Equal(t, miners[1].LastHealthCheck, ma1.LastHealthCheck)
	...
	assert.Equal(t, miners[2].LastHealthCheck, ma2.LastHealthCheck)
	...
	assert.Equal(t, sharders[2].LastHealthCheck, sa1.LastHealthCheck)
	...
	assert.Equal(t, sharders[3].LastHealthCheck, sa2.LastHealthCheck)
	...
	assert.Equal(t, validators[3].LastHealthCheck, va1.LastHealthCheck)
	...
	assert.Equal(t, validators[4].LastHealthCheck, va2.LastHealthCheck)
	...
	assert.Equal(t, authorizers[1].LastHealthCheck, aa1.LastHealthCheck)
	...
	assert.Equal(t, authorizers[3].LastHealthCheck, aa2.LastHealthCheck)
