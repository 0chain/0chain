...
func TestAddAndGetError(t *testing.T) {
	...
	gotErr, err := eventDb.GetErrorByTransactionHash("someTransaction", Pagination{0, 20, true})
	...
	gotErr, err = eventDb.GetErrorByTransactionHash("someT", Pagination{0, 20, true})
