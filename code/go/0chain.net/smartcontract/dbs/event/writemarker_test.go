...
func TestWriteMarker(t *testing.T) {
	...
	wms, err := eventDb.GetWriteMarkersForAllocationID(eWriteMarker.AllocationID, Pagination{20, 0, false})
	require.NoError(t, err)
