...
-- +goose Down
-- +goose StatementBegin
ALTER TABLE allocations DROP COLUMN IF EXISTS miner_count;
ALTER TABLE allocations DROP COLUMN IF EXISTS sharder_count;
ALTER TABLE allocations DROP COLUMN IF EXISTS blobber_count;
ALTER TABLE allocations DROP COLUMN IF EXISTS authorizer_count;
ALTER TABLE allocations DROP COLUMN IF EXISTS validator_count;
-- +goose StatementEnd