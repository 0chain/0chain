...
const (
	...
	StorageAllocationPoolMinLock         = SmartContract + StorageSc + "allocation_pool.min_lock"
	StorageAllocationPoolMinLockPeriod   = SmartContract + StorageSc + "allocation_pool.min_lock_period"
	StorageAllocationPoolMaxLockPeriod   = SmartContract + StorageSc + "allocation_pool.max_lock_period"
	...
	StorageMaxPoolsPerAllocation         = SmartContract + StorageSc + "max_pools_per_allocation"
