...
var (
	...
	Settings = map[string]struct {
		...
		"cost.kill-miner":              {CostKillMiner, smartcontract.Cost},
		"cost.kill-sharder":            {CostKillSharder, smartcontract.Cost},
		"cost.shut-down-miner":         {CostShutDownMiner, smartcontract.Cost},
		"cost.shut-down-sharder":       {CostShutDownSharder, smartcontract.Cost},
