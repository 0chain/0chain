...
func (msc *MinerSmartContract) InitSmartContractFunctions() {
	...
	msc.smartContractFunctions["kill-miner"] = msc.killMiner
	msc.smartContractFunctions["kill-sharder"] = msc.killSharder
	msc.smartContractFunctions["shut-down-miner"] = msc.shutDownMiner
	msc.smartContractFunctions["shut-down-sharder"] = msc.shutDownSharder
