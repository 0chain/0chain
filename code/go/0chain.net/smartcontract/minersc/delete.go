...
//func resetDeleteSharderIDs(state state.StateContextI) error {
//	_, err := state.InsertTrieNode(DeleteShardersKey, &NodeIDs{})
//	return err
//}

//func removeDeleteMinerID(state state.StateContextI, id string) error {
//	ids, err := getDeleteNodeIDs(state)
//	if err != nil {
//		return err
//	}
//
...
//	}
//	if !found {
//		return errors.New("delete miner id not found")
//	}
//
//	_, err = state.InsertTrieNode(DeleteMinersKey, &ids)
//	return err
//}

//func getDeleteShardersIDs(state state.StateContextI) (NodeIDs, error) {
//	ids, err := getNodeIDs(state, DeleteShardersKey)
//	if err != nil {
//		if err != util.ErrValueNotPresent {
//			return nil, err
//		}
...
//func saveDeleteSharderID(state state.StateContextI, id string) error {
//	ids, err := getDeleteShardersIDs(state)
//	if err != nil {
//		return err
//	}
//
...
//
//	ids = append(ids, id)
//	_, err = state.InsertTrieNode(DeleteShardersKey, &ids)
//	return err
//}

//func removeDeleteSharaderID(state state.StateContextI, id string) error {
//	ids, err := getDeleteShardersIDs(state)
//	if err != nil {
//		return err
//	}
...
//
//	if !found {
//		return errors.New("delete sharder id not found")
//	}
//
//	_, err = state.InsertTrieNode(DeleteShardersKey, &ids)
//	return err
