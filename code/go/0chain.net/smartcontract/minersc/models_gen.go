...
func (z *DelegatePoolStat) Msgsize() (s int) {
	s = 1 + 3 + msgp.StringPrefixSize + len(z.ID) + 8 + z.Balance.Msgsize() + 13 + z.InterestPaid.Msgsize() + 11 + z.RewardPaid.Msgsize() + 7 + msgp.StringPrefixSize + len(z.Status) + 5 + z.High.Msgsize() + 4 + z.Low.Msgsize()
	return
}
