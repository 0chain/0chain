			...
			input: (&MinerNode{
				...
				StakePool: &stakepool.StakePool{
					...
					Settings: stakepool.Settings{
						ServiceChargeRatio: stakepool.NewServiceCharge(viper.GetFloat64(bk.MinerMaxCharge)),
						MaxNumDelegates:    stakepool.NewDelegates(viper.GetInt(bk.MinerMaxDelegates)),
					},
				},
			}).Encode(),
		},
