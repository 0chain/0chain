...
func newTestInterestPoolSC() (ipsc *InterestPoolSmartContract) {
	ipsc = new(InterestPoolSmartContract)
	ipsc.SmartContract = new(smartcontractinterface.SmartContract)
	ipsc.ID = ADDRESS
	return
}
