...
func TestSimpleGlobalNode_Encode(t *testing.T) {
	type fields struct {
		MaxMint     currency.Coin
		TotalMinted currency.Coin
		MinLock     currency.Coin
		APR         float64
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{},
			want: []byte{
				123, 34, 109, 97, 120, 95, 109, 105, 110, 116, 34, 58, 48, 44, 34, 116, 111, 116, 97, 108, 95, 109, 105,
				110, 116, 101, 100, 34, 58, 48, 44, 34, 109, 105, 110, 95, 108, 111, 99, 107, 34, 58, 48, 44, 34, 97, 112,
				114, 34, 58, 48, 44, 34, 111, 119, 110, 101, 114, 95, 105, 100, 34, 58, 34, 34, 44, 34, 99, 111, 115, 116,
				34, 58, 110, 117, 108, 108, 125,
			},
		},
		{
			name: "full ok",
			...
			want: []byte{
				123, 34, 109, 97, 120, 95, 109, 105, 110, 116, 34, 58, 49, 48, 44, 34, 116, 111, 116, 97, 108, 95, 109, 105,
				110, 116, 101, 100, 34, 58, 49, 53, 44, 34, 109, 105, 110, 95, 108, 111, 99, 107, 34, 58, 49, 53, 44, 34, 97,
				112, 114, 34, 58, 50, 53, 44, 34, 111, 119, 110, 101, 114, 95, 105, 100, 34, 58, 34, 49, 55, 52, 54, 98, 48,
				54, 98, 98, 48, 57, 102, 53, 53, 101, 101, 48, 49, 98, 51, 51, 98, 53, 101, 50, 101, 48, 53, 53, 100, 54,
				99, 99, 55, 97, 57, 48, 48, 99, 98, 53, 55, 99, 48, 97, 51, 97, 53, 101, 97, 97, 98, 98, 56, 97, 48, 101,
				55, 55, 52, 53, 56, 48, 50, 34, 44, 34, 99, 111, 115, 116, 34, 58, 110, 117, 108, 108, 125,
			}},
	}
