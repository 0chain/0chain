...
func (z *Settings) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = append(o, 0xae, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x63, 0x68, 0x61, 0x72, 0x67, 0x65)
	o, err = msgp.AppendExtension(o, &z.ServiceChargeRatio)
	if err != nil {
...
func (z *Settings) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "service_charge":
			bts, err = msgp.ReadExtensionBytes(bts, &z.ServiceChargeRatio)
			if err != nil {
				err = msgp.WrapError(err, "ServiceChargeRatio")
				return
			}
...
func (z *Settings) Msgsize() (s int) {
	s = 1 + 15 + msgp.StringPrefixSize + len(z.DelegateWallet) + 9 + z.MinStake.Msgsize() + 9 + z.MaxStake.Msgsize() + 16 + msgp.IntSize + 15 + msgp.ExtensionPrefixSize + z.ServiceChargeRatio.Len()
	return
}
