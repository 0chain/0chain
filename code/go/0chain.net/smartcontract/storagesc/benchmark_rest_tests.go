		...
		},
		{
			...
			params: func() url.Values {
				...
				nar, _ := (&newAllocationRequest{
					...
					ReadPriceRange:             PriceRange{0, tokens.ZCNToSAS(viper.GetFloat64(bk.StorageMaxReadPrice))},
					WritePriceRange:            PriceRange{0, tokens.ZCNToSAS(viper.GetFloat64(bk.StorageMaxWritePrice))},
