...
func GetEndpoints(rh rest.RestHandlerI) []rest.Endpoint {
	...
	return []rest.Endpoint{
		{URI: storage + "/get_blobber_count", Handler: srh.getBlobberCount},
		{URI: storage + "/getBlobber", Handler: srh.getBlobber},
		{URI: storage + "/getblobbers", Handler: srh.getBlobbers},
		{URI: storage + "/get_blobber_total_stakes", Handler: srh.getBlobberTotalStakes},
		{URI: storage + "/get_blobber_lat_long", Handler: srh.getBlobberGeoLocation},
		{URI: storage + "/transaction", Handler: srh.getTransactionByHash},
		{URI: storage + "/transactions", Handler: srh.getTransactionByFilter},
		{URI: storage + "/writemarkers", Handler: srh.getWriteMarker},
		{URI: storage + "/errors", Handler: srh.getErrors},
		{URI: storage + "/allocations", Handler: srh.getAllocations},
		{URI: storage + "/allocation_min_lock", Handler: srh.getAllocationMinLock},
		{URI: storage + "/allocation", Handler: srh.getAllocation},
		{URI: storage + "/latestreadmarker", Handler: srh.getLatestReadMarker},
		{URI: storage + "/readmarkers", Handler: srh.getReadMarkers},
		{URI: storage + "/count_readmarkers", Handler: srh.getReadMarkersCount},
		{URI: storage + "/getWriteMarkers", Handler: srh.getWriteMarkers},
		{URI: storage + "/get_validator", Handler: srh.getValidator},
		{URI: storage + "/openchallenges", Handler: srh.getOpenChallenges},
		{URI: storage + "/getchallenge", Handler: srh.getChallenge},
		{URI: storage + "/getStakePoolStat", Handler: srh.getStakePoolStat},
		{URI: storage + "/getUserStakePoolStat", Handler: srh.getUserStakePoolStat},
		{URI: storage + "/get_block_by_hash", Handler: srh.getBlockByHash},
		{URI: storage + "/get_blocks", Handler: srh.getBlocks},
		{URI: storage + "/total_saved_data", Handler: srh.getTotalData},
		{URI: storage + "/storage_config", Handler: srh.getConfig},
		{URI: storage + "/getReadPoolStat", Handler: srh.getReadPoolStat},
		{URI: storage + "/getReadPoolAllocBlobberStat", Handler: srh.getReadPoolAllocBlobberStat},
		{URI: storage + "/getWritePoolStat", Handler: srh.getWritePoolStat},
		{URI: storage + "/getWritePoolAllocBlobberStat", Handler: srh.getWritePoolAllocBlobberStat},
		{URI: storage + "/getChallengePoolStat", Handler: srh.getChallengePoolStat},
		{URI: storage + "/alloc_written_size", Handler: srh.getWrittenAmount},
		{URI: storage + "/alloc_read_size", Handler: srh.getReadAmount},
		{URI: storage + "/alloc_write_marker_count", Handler: srh.getWriteMarkerCount},
		{URI: storage + "/collected_reward", Handler: srh.getCollectedReward},
		{URI: storage + "/blobber_ids", Handler: srh.getBlobberIdsByUrls},
		{URI: storage + "/alloc_blobbers", Handler: srh.getAllocationBlobbers},
		{URI: storage + "/free_alloc_blobbers", Handler: srh.getFreeAllocationBlobbers},
	}
}
