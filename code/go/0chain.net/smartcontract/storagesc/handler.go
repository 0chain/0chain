...
func GetEndpoints(rh rest.RestHandlerI) []rest.RestEndpoint {
	...
	return []rest.RestEndpoint{
		{storage + "/get_blobber_count", srh.getBlobberCount},
		{storage + "/getBlobber", srh.getBlobber},
		{storage + "/getblobbers", srh.getBlobbers},
		{storage + "/get_blobber_total_stakes", srh.getBlobberTotalStakes},
		{storage + "/get_blobber_lat_long", srh.getBlobberGeoLocation},
		{storage + "/transaction", srh.getTransactionByHash},
		{storage + "/transactions", srh.getTransactionByFilter},
		{storage + "/writemarkers", srh.getWriteMarker},
		{storage + "/errors", srh.getErrors},
		{storage + "/allocations", srh.getAllocations},
		{storage + "/allocation_min_lock", srh.getAllocationMinLock},
		{storage + "/allocation", srh.getAllocation},
		{storage + "/latestreadmarker", srh.getLatestReadMarker},
		{storage + "/readmarkers", srh.getReadMarkers},
		{storage + "/count_readmarkers", srh.getReadMarkersCount},
		{storage + "/getWriteMarkers", srh.getWriteMarkers},
		{storage + "/get_validator", srh.getValidator},
		{storage + "/openchallenges", srh.getOpenChallenges},
		{storage + "/getchallenge", srh.getChallenge},
		{storage + "/getStakePoolStat", srh.getStakePoolStat},
		{storage + "/getUserStakePoolStat", srh.getUserStakePoolStat},
		{storage + "/get_block_by_hash", srh.getBlockByHash},
		{storage + "/get_blocks", srh.getBlocks},
		{storage + "/total_saved_data", srh.getTotalData},
		{storage + "/getConfig", srh.getConfig},
		{storage + "/getReadPoolStat", srh.getReadPoolStat},
		{storage + "/getReadPoolAllocBlobberStat", srh.getReadPoolAllocBlobberStat},
		{storage + "/getWritePoolStat", srh.getWritePoolStat},
		{storage + "/getWritePoolAllocBlobberStat", srh.getWritePoolAllocBlobberStat},
		{storage + "/getChallengePoolStat", srh.getChallengePoolStat},
		{storage + "/alloc_written_size", srh.getWrittenAmount},
		{storage + "/alloc_read_size", srh.getReadAmount},
		{storage + "/alloc_write_marker_count", srh.getWriteMarkerCount},
		{storage + "/collected_reward", srh.getCollectedReward},
		{storage + "/blobber_ids", srh.getBlobberIdsByUrls},
		{storage + "/alloc_blobbers", srh.getAllocationBlobbers},
		{storage + "/free_alloc_blobbers", srh.getFreeAllocationBlobbers},
	}
}
