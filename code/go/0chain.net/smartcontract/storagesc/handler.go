...
func GetEndpoints(rh rest.RestHandlerI) []rest.RestEndpoint {
	...
	return []rest.RestEndpoint{
		{Name: storage + "/get_blobber_count", Endpoint: srh.getBlobberCount},
		{Name: storage + "/getBlobber", Endpoint: srh.getBlobber},
		{Name: storage + "/getblobbers", Endpoint: srh.getBlobbers},
		{Name: storage + "/get_blobber_total_stakes", Endpoint: srh.getBlobberTotalStakes},
		{Name: storage + "/get_blobber_lat_long", Endpoint: srh.getBlobberGeoLocation},
		{Name: storage + "/transaction", Endpoint: srh.getTransactionByHash},
		{Name: storage + "/transactions", Endpoint: srh.getTransactionByFilter},
		{Name: storage + "/writemarkers", Endpoint: srh.getWriteMarker},
		{Name: storage + "/errors", Endpoint: srh.getErrors},
		{Name: storage + "/allocations", Endpoint: srh.getAllocations},
		{Name: storage + "/allocation_min_lock", Endpoint: srh.getAllocationMinLock},
		{Name: storage + "/allocation", Endpoint: srh.getAllocation},
		{Name: storage + "/latestreadmarker", Endpoint: srh.getLatestReadMarker},
		{Name: storage + "/readmarkers", Endpoint: srh.getReadMarkers},
		{Name: storage + "/count_readmarkers", Endpoint: srh.getReadMarkersCount},
		{Name: storage + "/getWriteMarkers", Endpoint: srh.getWriteMarkers},
		{Name: storage + "/get_validator", Endpoint: srh.getValidator},
		{Name: storage + "/openchallenges", Endpoint: srh.getOpenChallenges},
		{Name: storage + "/getchallenge", Endpoint: srh.getChallenge},
		{Name: storage + "/getStakePoolStat", Endpoint: srh.getStakePoolStat},
		{Name: storage + "/getUserStakePoolStat", Endpoint: srh.getUserStakePoolStat},
		...
		{Name: storage + "/getWritePoolAllocBlobberStat", Endpoint: srh.getWritePoolAllocBlobberStat},
		{Name: storage + "/getChallengePoolStat", Endpoint: srh.getChallengePoolStat},
		{Name: storage + "/alloc_written_size", Endpoint: srh.getWrittenAmount},
		{Name: storage + "/alloc_read_size", Endpoint: srh.getReadAmount},
		{Name: storage + "/alloc_write_marker_count", Endpoint: srh.getWriteMarkerCount},
		{Name: storage + "/collected_reward", Endpoint: srh.getCollectedReward},
		{Name: storage + "/blobber_ids", Endpoint: srh.getBlobberIdsByUrls},
		{Name: storage + "/alloc_blobbers", Endpoint: srh.getAllocationBlobbers},
		{Name: storage + "/free_alloc_blobbers", Endpoint: srh.getFreeAllocationBlobbers},
	}
}
