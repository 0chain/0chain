...
type freeStorageAssigner struct {
	...
	PublicKey          string             `json:"public_key"`
	IndividualLimit    int64              `json:"individual_limit"`
	TotalLimit         int64              `json:"total_limit"`
	CurrentRedeemed    int64              `json:"current_redeemed"`
...
func (ssc *StorageSmartContract) addFreeStorageAssigner(
	...
	var newTotalLimit = tokens.ZCNToSAS(assignerInfo.TotalLimit)
	...
	var newIndividualLimit = tokens.ZCNToSAS(assignerInfo.IndividualLimit)
