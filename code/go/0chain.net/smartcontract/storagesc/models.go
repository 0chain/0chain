...
type StorageNode struct {
	...
	DataReadLastRound        float64                `json:"data_read_last_round"`         // in GB
	LastRoundDataReadUpdated int64                  `json:"last_round_data_read_updated"` // last round when data read was updated
