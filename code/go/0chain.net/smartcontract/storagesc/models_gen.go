...
func (z *StorageAllocationDecode) Msgsize() (s int) {
	...
	s += 12 + msgp.BoolSize + 21 + msgp.BoolSize + 12 + msgp.Uint8Size + 10 + z.WritePool.Msgsize() + 15 + 1 + 4 + z.ReadPriceRange.Min.Msgsize() + 4 + z.ReadPriceRange.Max.Msgsize() + 16 + 1 + 4 + z.WritePriceRange.Min.Msgsize() + 4 + z.WritePriceRange.Max.Msgsize() + 10 + z.StartTime.Msgsize() + 10 + msgp.BoolSize + 9 + msgp.BoolSize + 17 + z.MovedToChallenge.Msgsize() + 10 + z.MovedBack.Msgsize() + 18 + z.MovedToValidators.Msgsize() + 9 + msgp.DurationSize + 9 + msgp.ArrayHeaderSize
	for za0003 := range z.Curators {
...
func (z *StorageNode) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// string "LastRewardPartition"
	o = append(o, 0xb3, 0x4c, 0x61, 0x73, 0x74, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x50, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e)
	// map header, size 3
	// string "Index"
	o = append(o, 0x83, 0xa5, 0x49, 0x6e, 0x64, 0x65, 0x78)
	o = msgp.AppendInt(o, z.LastRewardPartition.Index)
	// string "StartRound"
	o = append(o, 0xaa, 0x53, 0x74, 0x61, 0x72, 0x74, 0x52, 0x6f, 0x75, 0x6e, 0x64)
	o = msgp.AppendInt64(o, z.LastRewardPartition.StartRound)
	// string "Timestamp"
	o = append(o, 0xa9, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70)
	o, err = z.LastRewardPartition.Timestamp.MarshalMsg(o)
	if err != nil {
		err = msgp.WrapError(err, "LastRewardPartition", "Timestamp")
		return
	}
...
func (z *StorageNode) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "LastRewardPartition":
			var zb0003 uint32
			zb0003, bts, err = msgp.ReadMapHeaderBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "LastRewardPartition")
				return
			}
			for zb0003 > 0 {
				zb0003--
				...
				switch msgp.UnsafeString(field) {
				case "Index":
					z.LastRewardPartition.Index, bts, err = msgp.ReadIntBytes(bts)
					if err != nil {
						err = msgp.WrapError(err, "LastRewardPartition", "Index")
						return
					}
				case "StartRound":
					z.LastRewardPartition.StartRound, bts, err = msgp.ReadInt64Bytes(bts)
					if err != nil {
						err = msgp.WrapError(err, "LastRewardPartition", "StartRound")
						return
					}
				case "Timestamp":
					bts, err = z.LastRewardPartition.Timestamp.UnmarshalMsg(bts)
					if err != nil {
						err = msgp.WrapError(err, "LastRewardPartition", "Timestamp")
						return
					}
...
func (z *StorageNode) Msgsize() (s int) {
	...
	s += 8 + msgp.StringPrefixSize + len(z.BaseURL) + 13 + z.ProviderType.Msgsize() + 12 + 1 + 9 + msgp.Float64Size + 10 + msgp.Float64Size + 6 + z.Terms.Msgsize() + 9 + msgp.Int64Size + 10 + msgp.Int64Size + 10 + msgp.StringPrefixSize + len(z.PublicKey) + 10 + msgp.Int64Size + 24 + msgp.Float64Size + 24 + msgp.Int64Size + 18 + z.StakePoolSettings.Msgsize() + 20 + 1 + 6 + msgp.IntSize + 11 + msgp.Int64Size + 10 + z.LastRewardPartition.Timestamp.Msgsize() + 16 + 1 + 6 + msgp.IntSize + 11 + msgp.Int64Size + 10 + z.RewardPartition.Timestamp.Msgsize()
	return
}
...
func (z *ValidationNode) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// string "PartitionPosition"
	o = append(o, 0xb1, 0x50, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e)
	o = msgp.AppendInt(o, z.PartitionPosition)
	return
}
...
func (z *ValidationNode) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "PartitionPosition":
			z.PartitionPosition, bts, err = msgp.ReadIntBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "PartitionPosition")
				return
			}
		default:
			bts, err = msgp.Skip(bts)
...
func (z *ValidationNode) Msgsize() (s int) {
	...
	s += 8 + msgp.StringPrefixSize + len(z.BaseURL) + 13 + z.ProviderType.Msgsize() + 18 + z.StakePoolSettings.Msgsize() + 18 + msgp.IntSize
	return
}
...
func (z *WriteMarker) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 12
	// string "AllocationRoot"
	o = append(o, 0x8c, 0xae, 0x41, 0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x6f, 0x6f, 0x74)
	o = msgp.AppendString(o, z.AllocationRoot)
