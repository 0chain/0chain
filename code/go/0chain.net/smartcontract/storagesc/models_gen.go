...
func (z AllocOpenChallenge) Msgsize() (s int) {
	s = 1 + 3 + msgp.StringPrefixSize + len(z.ID) + 15 + msgp.Int64Size + 10 + msgp.StringPrefixSize + len(z.BlobberID)
	return
}
...
func (z *BlobberAllocation) Msgsize() (s int) {
	...
	s += 6 + 1 + 10 + z.Terms.ReadPrice.Msgsize() + 11 + z.Terms.WritePrice.Msgsize() + 14 + z.MinLockDemand.Msgsize() + 6 + z.Spent.Msgsize() + 8 + z.Penalty.Msgsize() + 11 + z.ReadReward.Msgsize() + 9 + z.Returned.Msgsize() + 16 + z.ChallengeReward.Msgsize() + 27 + z.ChallengePoolIntegralValue.Msgsize() + 25
	if z.LatestCompletedChallenge == nil {
		s += msgp.NilSize
	} else {
...
func (z *allocationChallengesDecoder) MarshalMsg(b []byte) (o []byte, err error) {
	...
	for za0001 := range z.OpenChallenges {
		if z.OpenChallenges[za0001] == nil {
			...
			// string "RoundCreatedAt"
			o = append(o, 0xae, 0x52, 0x6f, 0x75, 0x6e, 0x64, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74)
			o = msgp.AppendInt64(o, z.OpenChallenges[za0001].RoundCreatedAt)
			// string "BlobberID"
			o = append(o, 0xa9, 0x42, 0x6c, 0x6f, 0x62, 0x62, 0x65, 0x72, 0x49, 0x44)
			...
			for za0001 := range z.OpenChallenges {
				if msgp.IsNil(bts) {
					...
					for zb0003 > 0 {
						...
						case "RoundCreatedAt":
							z.OpenChallenges[za0001].RoundCreatedAt, bts, err = msgp.ReadInt64Bytes(bts)
							if err != nil {
...
func (z *allocationChallengesDecoder) Msgsize() (s int) {
	...
	for za0001 := range z.OpenChallenges {
		if z.OpenChallenges[za0001] == nil {
			...
			s += 1 + 3 + msgp.StringPrefixSize + len(z.OpenChallenges[za0001].ID) + 15 + msgp.Int64Size + 10 + msgp.StringPrefixSize + len(z.OpenChallenges[za0001].BlobberID)
		}
	}
	return
}
