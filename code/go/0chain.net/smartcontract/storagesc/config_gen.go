...
func (z *Config) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 30
	// string "TimeUnit"
	o = append(o, 0xde, 0x0, 0x1e, 0xa8, 0x54, 0x69, 0x6d, 0x65, 0x55, 0x6e, 0x69, 0x74)
