...
func (z *Config) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if z.WritePool == nil {
		...
		// string "MinLock"
		o = append(o, 0x83, 0xa7, 0x4d, 0x69, 0x6e, 0x4c, 0x6f, 0x63, 0x6b)
		o = msgp.AppendInt64(o, z.WritePool.MinLock)
		// string "MinLockPeriod"
		o = append(o, 0xad, 0x4d, 0x69, 0x6e, 0x4c, 0x6f, 0x63, 0x6b, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64)
	...
	if z.StakePool == nil {
		...
		o = msgp.AppendInt64(o, z.StakePool.MinLock)
	}
	...
	o = msgp.AppendInt64(o, z.MaxTotalFreeAllocation)
	...
	o = msgp.AppendInt64(o, z.MaxIndividualFreeAllocation)
...
func (z *Config) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "ReadPool":
			if msgp.IsNil(bts) {
				...
				for zb0002 > 0 {
					...
					switch msgp.UnsafeString(field) {
					case "MinLock":
						z.ReadPool.MinLock, bts, err = msgp.ReadInt64Bytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "ReadPool", "MinLock")
							return
						}
					case "MinLockPeriod":
						z.ReadPool.MinLockPeriod, bts, err = msgp.ReadDurationBytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "ReadPool", "MinLockPeriod")
							return
						}
					case "MaxLockPeriod":
						z.ReadPool.MaxLockPeriod, bts, err = msgp.ReadDurationBytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "ReadPool", "MaxLockPeriod")
							return
						}
					default:
		...
		case "WritePool":
			if msgp.IsNil(bts) {
				...
				for zb0003 > 0 {
					...
					switch msgp.UnsafeString(field) {
					case "MinLock":
						z.WritePool.MinLock, bts, err = msgp.ReadInt64Bytes(bts)
						if err != nil {
		...
		case "StakePool":
			if msgp.IsNil(bts) {
				...
				for zb0004 > 0 {
					...
					switch msgp.UnsafeString(field) {
					case "MinLock":
						z.StakePool.MinLock, bts, err = msgp.ReadInt64Bytes(bts)
						if err != nil {
		...
		case "MaxReadPrice":
			z.MaxReadPrice, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "MaxReadPrice")
				return
			}
		case "MaxWritePrice":
			z.MaxWritePrice, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "MaxWritePrice")
				return
			}
		case "MinWritePrice":
			z.MinWritePrice, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
		...
		case "MaxTotalFreeAllocation":
			z.MaxTotalFreeAllocation, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "MaxTotalFreeAllocation")
				return
			}
		case "MaxIndividualFreeAllocation":
			z.MaxIndividualFreeAllocation, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
...
func (z *Config) Msgsize() (s int) {
	s = 3 + 9 + msgp.DurationSize + 8 + msgp.Int64Size + 7 + msgp.Int64Size + 13 + msgp.Int64Size + 17 + msgp.DurationSize + 27 + msgp.DurationSize + 17 + msgp.DurationSize + 19 + msgp.Int64Size + 9
	if z.ReadPool == nil {
		s += msgp.NilSize
	} else {
		s += 1 + 8 + msgp.Int64Size + 14 + msgp.DurationSize + 14 + msgp.DurationSize
	}
	s += 10
	if z.WritePool == nil {
		s += msgp.NilSize
	...
	s += 16 + msgp.Float64Size + 13 + msgp.Float64Size + 13 + msgp.Int64Size + 14 + msgp.Int64Size + 14 + msgp.Int64Size + 25 + msgp.IntSize + 32 + msgp.IntSize + 23 + msgp.Int64Size + 28 + msgp.Int64Size + 23 + z.FreeAllocationSettings.Msgsize() + 17 + msgp.BoolSize + 27 + msgp.IntSize + 23 + msgp.IntSize + 24 + msgp.Float64Size + 9 + msgp.Int64Size + 9 + msgp.Int64Size + 13 + msgp.IntSize + 10 + msgp.Float64Size + 12
	if z.BlockReward == nil {
		s += msgp.NilSize
	} else {
...
func (z *blockReward) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = msgp.AppendInt64(o, z.QualifyingStake)
...
func (z *blockReward) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "QualifyingStake":
			z.QualifyingStake, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
...
func (z *blockReward) Msgsize() (s int) {
	s = 1 + 12 + msgp.Int64Size + 24 + msgp.Int64Size + 23 + msgp.Float64Size + 16 + msgp.Int64Size + 14 + msgp.Float64Size + 12 + msgp.Float64Size + 14 + msgp.Float64Size + 14 + msgp.Int64Size
	return
}
