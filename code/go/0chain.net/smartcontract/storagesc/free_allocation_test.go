...
func TestFreeAllocationRequest(t *testing.T) {
	...
	setExpectations := func(t *testing.T, name string, p parameters, want want) args {
		...
		balances.On("InsertTrieNode", "6dba10422e368813802877a85039d3985d96760ed844092319743fb3a76712d7:writepool:mock recipient", mock.Anything).Return("", nil).Once()
		balances.On(
