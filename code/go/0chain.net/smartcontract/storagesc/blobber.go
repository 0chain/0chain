...
func (ssc *StorageSmartContract) updateBlobber(t *transaction.Transaction,
	...
	if blobber.Capacity <= 0 {
		return ssc.removeBlobber(t, blobber, blobbers, balances)
	}
...
func (ssc *StorageSmartContract) removeBlobber(t *transaction.Transaction,
...
func (ssc *StorageSmartContract) blobberHealthCheck(t *transaction.Transaction,
	...
	_, err = balances.InsertTrieNode(blobber.GetKey(ssc.ID),
		blobber)
	if err != nil {
		return "", common.NewError("blobber_health_check_failed",
