...
func (sc *StorageSmartContract) blobberReward(t *transaction.Transaction,
	...
	err = sp.DistributeRewards(blobberReward, blobAlloc.BlobberID, spenum.Blobber, "br", balances)
	if err != nil {
...
func (sc *StorageSmartContract) blobberPenalty(t *transaction.Transaction,
	...
	if conf.BlobberSlash > 0 && move > 0 &&
		...
		move, err = sp.slash(blobAlloc.BlobberID, blobAlloc.Offer(), slash, "blobberPenalty", balances)
		if err != nil {
