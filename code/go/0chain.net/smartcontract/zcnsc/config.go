...
func loadGlobalNode() (conf *ZCNSConfig) {
	conf = new(ZCNSConfig)
	conf.MinMintAmount = cfg.GetInt64(postfix(MinMintAmount))
	conf.MinBurnAmount = cfg.GetInt64(postfix(MinBurnAmount))
	conf.MinStakeAmount = cfg.GetInt64(postfix(MinStakeAmount))
	...
	conf.MaxFee = cfg.GetInt64(postfix(MaxFee))
