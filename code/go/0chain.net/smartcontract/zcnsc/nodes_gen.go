...
func (z *GlobalNode) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 4
	// string "ZCNSConfig"
	o = append(o, 0x84, 0xaa, 0x5a, 0x43, 0x4e, 0x53, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67)
	if z.ZCNSConfig == nil {
		o = msgp.AppendNil(o)
	} else {
	...
	o = msgp.AppendString(o, z.ID)
	// string "UserNonceMinted"
	o = append(o, 0xaf, 0x55, 0x73, 0x65, 0x72, 0x4e, 0x6f, 0x6e, 0x63, 0x65, 0x4d, 0x69, 0x6e, 0x74, 0x65, 0x64)
	o = msgp.AppendMapHeader(o, uint32(len(z.UserNonceMinted)))
	keys_za0001 := make([]string, 0, len(z.UserNonceMinted))
	for k := range z.UserNonceMinted {
		keys_za0001 = append(keys_za0001, k)
	}
	msgp.Sort(keys_za0001)
	for _, k := range keys_za0001 {
		za0002 := z.UserNonceMinted[k]
...
func (z *GlobalNode) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "UserNonceMinted":
			var zb0002 uint32
			zb0002, bts, err = msgp.ReadMapHeaderBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "UserNonceMinted")
				return
			}
			if z.UserNonceMinted == nil {
				z.UserNonceMinted = make(map[string]int64, zb0002)
			} else if len(z.UserNonceMinted) > 0 {
				for key := range z.UserNonceMinted {
					delete(z.UserNonceMinted, key)
				}
			}
			for zb0002 > 0 {
				var za0001 string
				...
				if err != nil {
					err = msgp.WrapError(err, "UserNonceMinted", za0001)
					return
				}
				z.UserNonceMinted[za0001] = za0002
			}
		case "BurnNonce":
...
func (z *GlobalNode) Msgsize() (s int) {
	...
	s += 3 + msgp.StringPrefixSize + len(z.ID) + 16 + msgp.MapHeaderSize
	if z.UserNonceMinted != nil {
		for za0001, za0002 := range z.UserNonceMinted {
			_ = za0002
