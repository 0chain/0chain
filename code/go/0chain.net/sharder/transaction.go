...
func (sc *Chain) storeTransactions(sTxns []datastore.Entity, roundNumber int64) error {
	...
	if err != nil {
		logging.Logger.Error("Jayash storeTxn err-1", zap.Int64("round", roundNumber), zap.Error(err))
		return err
	}
	...
	if err != nil {
		logging.Logger.Error("Jayash storeTxn err-2", zap.Int64("round", roundNumber), zap.Error(err))
		return err
	}
	...
	err = tCon.Commit()
	if err != nil {
		logging.Logger.Error("Jayash storeTxn err-3", zap.Int64("round", roundNumber), zap.Error(err))
		return err
	}
	return nil
}
