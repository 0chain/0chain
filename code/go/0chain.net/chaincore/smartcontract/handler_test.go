...
func TestExecuteSmartContract(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want:    "{\"simple_miner\":{\"last_health_check\":0,\"is_shut_down\":false,\"is_killed\":false,\"id\":\"\",\"n2n_host\":\"\",\"host\":\"\",\"port\":0,\"geolocation\":{\"latitude\":0,\"longitude\":0},\"path\":\"\",\"public_key\":\"\",\"short_name\":\"\",\"build_tag\":\"\",\"total_stake\":0,\"delete\":false,\"last_setting_update_round\":0},\"stake_pool\":null}",
			wantErr: false,
		},
	}
	for _, tt := range tests {
