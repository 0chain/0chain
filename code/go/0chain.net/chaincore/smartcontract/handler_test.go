...
func TestExecuteSmartContract(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want:    "{\"simple_miner\":{\"id\":\"\",\"n2n_host\":\"\",\"host\":\"\",\"port\":0,\"geolocation\":{\"latitude\":0,\"longitude\":0},\"path\":\"\",\"public_key\":\"\",\"short_name\":\"\",\"build_tag\":\"\",\"total_stake\":0,\"delete\":false,\"delegate_wallet\":\"\",\"service_charge\":0,\"number_of_delegates\":0,\"min_stake\":0,\"max_stake\":0,\"stat\":{},\"last_health_check\":0},\"stake_pool\":{\"pools\":{},\"rewards\":0,\"settings\":{\"delegate_wallet\":\"\",\"min_stake\":0,\"max_stake\":0,\"num_delegates\":0,\"service_charge\":0},\"minter\":0}}",
			wantErr: false,
		},
	}
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			fmt.Println("test", tt, "got", got, "tt.want", tt.want)
			if got != tt.want {
