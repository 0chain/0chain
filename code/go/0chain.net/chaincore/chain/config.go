...
func (c *ConfigImpl) FromViper() error {
	...
	conf.DbsSettings.RollingPartitionChangePeriod = viper.GetInt64("server_chain.dbs.settings.rolling_partition_change_period")
	conf.DbsSettings.RollingPartitionKeepCount = viper.GetInt64("server_chain.dbs.settings.rolling_partition_keep_count")
