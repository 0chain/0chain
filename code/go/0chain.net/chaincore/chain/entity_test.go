...
func (suite *MinerTestSuite) TestAddBlock() {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("AddNotarizedBlockToRound() got = %v, want %v", got, tt.want)
			}
			if !reflect.DeepEqual(got1, tt.want1) {
				t.Errorf("AddNotarizedBlockToRound() got1 = %v, want %v", got1, tt.want1)
			}
		})
	}
}
...
func TestChain_AddRoundBlock(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := c.AddRoundBlock(tt.args.r, tt.args.b); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("AddRoundBlock() = %v, want %v", got, tt.want)
			}
		})
	}
}
