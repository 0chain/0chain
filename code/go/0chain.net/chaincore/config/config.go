...
func SetupDefaultConfig() {
	...
	viper.SetDefault("server_chain.blobbers.max_blobbers_per_allocation", 40)
	fmt.Println(viper.GetInt("server_chain.blobbers.max_blobbers_per_allocation"), "came here maybe")
}
